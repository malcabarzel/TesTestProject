...
RemarkDsc: "עיקר הפתיחה הוא הצגת הטענה/ התופעה בהכללה , חסרונה עלול לגרום לנימוקים לקויים. העתיקי מהשאלון את הטענה ושלבי בפתיחה/בדגם דיון הציגי את שני צידי הדיון(שתי הטענות הסותרות).", },
...
RemarkDsc: "	42.	הביסוס אינו מוכיח את משפט המפתח/ ביססת את הנימוק לנימוק/ ההרחבה אינה קשורה ישירות לתופעה או לטענה הכללית/ השירשור אינו הגיוני . כתבי ביסוס מתאים יותר.  ", },
...
{ RemarkId:"33",TestPartId: 2,TestTypeId: 1, RemarkPoints:2, RemarkName: "הערת מבנה", 
    RemarkDsc: "	דייקי בניסוח שאלות קישור: מדוע? כיצד? מה? ולא האם? (האם ? האומנם? -ניתן לשאול רק לפני הצגת הטענה לאחר טענת הנגד) כתבי רק שאלות קישור שמשפטי המפתח עונים עליהם ", },
...
RemarkDsc: "מילת הקישור אינה מתאימה במדויק לקשר ההגיוני בין המשפטים/ הפסקות. מחקי /שני אותה. 🧷(אל תכתבי - ראשית / - עם זאת - משמעותו ויתור/ - מה גם - משמעותו קל וחומר, ולא הוספה/למשל משמעותו -דוגמא ולא משל ).", },
...
RemarkDsc: "ט)  לא התכוונת לזה... המבע המסומן אינו מבטא נכון / מדויק את מה שאת רוצה להביע ופוגם בנכונות הרעיון. מחקי / בחרי מבע מתאים יותר.	", },
...
RemarkDsc: ' יא) השימוש בביטוי המסומן אינו תקין /מתאים / מדויק/ אין מילה כזו. 🎈 בחרי ביטוי מתאים יותר / מחקי אותו. 🗑', },
