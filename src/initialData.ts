...
export const finalGradeLevels: string[] = [
  `-50 מצוין`,
  `-45 ט"מ`,
  `-40 טוב`,
  `-35 גבולי`,
...
export const remarks: Remark[] = [
  ...
  },
  {
    ...
    RemarkDsc: "	11.	הביסוס אינו מוכיח את משפט המפתח/ ביססת את הנימוק לנימוק/ ההרחבה אינה קשורה ישירות לתופעה או לטענה הכללית. כתבי ביסוס מתאים יותר.  ",
  },
  {
  ...
  {
    RemarkId: "22", TestPartId: 2, TestTypeId: 1, RemarkPoints: 2, RemarkName: "הערת מבנה",
  ...
  },
  {
    ...
    RemarkDsc: "דייקי בניסוח שאלות קישור: מדוע? כיצד? מה? ולא: 'האם' /כתבי רק שאלות קישור שמשפטי המפתח עונים עליהן. ",
  },
  {
  ...
  {
    RemarkId: "42", TestPartId: 2, TestTypeId: 1, RemarkPoints: 2, RemarkName: "הערת מבנה",
  ...
  {
    RemarkId: "45", TestPartId: 2, TestTypeId: 1, RemarkPoints: 2, RemarkName: "הערת מבנה",
